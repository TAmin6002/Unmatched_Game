                ...
                switch (FF.get_number_of_choose())
                {
                    ...
                    case 0: // Attack
                    {
                        if (turn->get_count() < 2)
                        {
                            ...
                            if (Attacker != nullptr && Defender != nullptr && Attacker_selected_card != nullptr)
                            {
                            try
                            {
                                ...
                                // Attacking costs the attacker part of their remaining movement.
                        ...
                        if (turn->get_count() < 2)
                        {
                            try
                            {
                                ...
                                if (selected != nullptr)
                                {
                                    ...
                                    // MoveHero throws if the hero has no legal destination
                                    // (e.g. boxed in by other heroes) - that must not skip the
                                    // turn->add_count() below or crash the whole program.
